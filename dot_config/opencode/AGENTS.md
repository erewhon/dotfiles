...
- Most projects use **jj** (Jujutsu), not git. Check for `.jj/` before assuming git.
...
- `meta-agent` - Create new agent definitions
...
- `/do-feature` - Execute feature tasks in dependency order

## Local Infrastructure

- LLM router at `http://euclid:4010/v1` (also via Tailscale: `https://llm.peacock-bramble.ts.net`)
- Nous notebook app for notes, goals, and daily planning
- Gaol container management for nspawn containers
