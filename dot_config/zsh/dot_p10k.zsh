# Generated by Powerlevel10k configuration wizard on 2020-12-13 at 20:19 CST.
...
() {
  ...
  # SPB: always show context?  typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION=
